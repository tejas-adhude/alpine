...
```
#### info 
conatain the info of the script , dynamically updated.
...
|------------------|------------------|------------------|------------------|
|constValues    |tradeValues        |-      |constructor<br>validate_timeFrame      |
|prices     |tradeValues        |-      |constructor<br>set_tradeValue<br>get_tradeValue        |
|candleData     |tradeValues        |-      |constructor<br>set_candles_data<br>get_candles_data        |
...
|get_tradeValue     |get the required value for script      |scname,valueType       |object        |{"name":scName,valueType:value}     |none        |
...
|get_candles_data       |get the candle data        |scname,timeFrame       |object       |-data object<br>-none<br>ex.candlesData={"name":"NIFTY2372019800","timeFrame":"1min","data":[[dateTimeObj,"12.23","34.54","56.56","67.56"],[dateTimeObj,"23","34","34.56","12"]]}     |none       |

### ```parameter discription```
|PARAMTER NAME       |PARAMETER DISCRIPTION     |PARAMETER TYPE     |VALID VALUES        |
|----------------------|-----------------------|-----------------------|-----------------------|
|valueType        | value type for script       |str        |"tokenId"<br>"buyP"<br>"sellP"<br>"strikeP"<br>"ltp"<br>"highP"<br>"lowP"     |
...
|set_tradeValue     |tradeValues        |-      |-      |
|get_tradeValue     |tradeValues        |-      |-      |
|set_candles_data       |tradeValues        |-      |-      |
|get_candles_data       |tradeValues        |-      |-      |
